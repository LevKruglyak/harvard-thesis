...
This is one definition of the \defn{Chern classes}, cohomology classes for complex vector bundles with coefficients $\Z$ in singular homology. As 
...
\begin{remark}
	Many of the motivations for studying Weyl groups and maximal tori arise in representation theory. The representation of a torus $T$ is well-understood, \todo{write some more}
\end{remark}
...
\todo{Talk about $U_n$, its maximal torus, and normalizer group isomorphic to $\Sym_n$. There is some cool geometry happening here under the hood}
