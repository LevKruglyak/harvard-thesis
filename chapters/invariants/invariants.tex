...
\addplot table[x index=0, y index=1] {chapters/invariants/lowdim.dat};
\addplot table[x index=0, y index=2] {chapters/invariants/lowdim.dat};
\addplot table[x index=0, y index=3] {chapters/invariants/lowdim.dat};

\legend{$|bP^{4k}|$,$\milinv$,$\ekinv$}
...
\addplot table[x index=0, y index=1] {chapters/invariants/highdim.dat};
\addplot table[x index=0, y index=2] {chapters/invariants/highdim.dat};
\addplot table[x index=0, y index=3] {chapters/invariants/highdim.dat};
