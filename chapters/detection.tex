...
\begin{definition}
	Two closed $n$-manifolds $X_1$ and $X_2$ are said to be \defn{(oriented) cobordant}[oriented cobordism] if there is an $(n+1)$-manifold $W$ with $\partial W = X_1\sqcup (-X_2)$. We use the notation $W : X_1\sobord X_2$ to refer to the \defn{cobordism} $W$.
\end{definition}
...
\begin{definition}
	The \defn{oriented cobordism ring}, denoted $\Omega_\bullet^\SO$ is the set of oriented cobordism classes with the operations of disjoint union and product.
\end{definition}
